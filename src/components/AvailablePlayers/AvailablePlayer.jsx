        ...
        <div className="card bg-base-100 shadow-xl p-4">
            ...
            <div className="mt-4">
                ...
                <div className='flex justify-between border-b-1 border-gray-200 mt-3 pb-3'>
                    ...
                    <p className='text-[14px] bg-gray-200 px-3 py-1 rounded-md'>{playing_role}</p>
                </div>
                ...
                <div className="card-actions flex justify-between items-center">
                    ...
                    <button className=" border-1 border-gray-200 rounded-md hover:bg-gray-100 px-3 py-1 text-[14px] font-normal">Choose Player</button>
                </div>
            </div>
        </div>
    );
